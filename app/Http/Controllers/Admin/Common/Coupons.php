...
class Coupons extends Controller
{
    ...
    public function index2(Request $request)
    {
        ...
        $status_update = SM::check_this_method_access('coupons', 'status_update') ? 1 : 0;
    ...
    public function create()
    {
        ...
        return view("nptl-admin/common/coupon/create", $data);
    }
...
//	}
    ...
    public function edit($id)
    {
        ...
        if (count($data["coupon_info"]) > 0) {
            ...
            return view("nptl-admin/common/coupon/edit", $data);
        } else {
            return redirect(SM::smAdminSlug('coupons'))
