...
class Tags extends Controller
{
    ...
    {
        $edit = SM::check_this_method_access('tags', 'edit') ? 1 : 0;
        $status_update = SM::check_this_method_access('tags', 'status_update') ? 1 : 0;
        $delete = SM::check_this_method_access('tags', 'destroy') ? 1 : 0;
        $per = $edit + $delete;
...
//	}
    ...
    public function edit($id)
    {
        ...
        if (count($data['tag_info']) > 0) {
            ...
            $data['rightButton2']['iconClass'] = 'fa fa-tags';
            $data['rightButton2']['text'] = 'Tag List';
            $data['rightButton2']['link'] = 'tags';
            $data['rightButton4']['iconClass'] = 'fa fa-eye';
            $data['rightButton4']['text'] = 'View';
            $data['rightButton4']['link'] = "product/tag/" . $data['tag_info']->slug;

            return view('nptl-admin/common/tag/edit', $data);
        } else {
            return redirect(SM::smAdminSlug("tags"))
