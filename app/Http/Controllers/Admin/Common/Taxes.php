...
class Taxes extends Controller
{
    ...
    public function index()
    {
        ...
        return view("nptl-admin/common/tax/index", $data);
    }
    ...
    public function create()
    {
        ...
        return view("nptl-admin/common/tax/create", $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (SM::is_admin() || isset($permission) &&
            isset($permission['tax']['status_update'])
            && $permission['tax']['status_update'] == 1) {
...
//	}
    ...
    public function edit($id)
    {
        ...
        if (count($data["tax_info"]) > 0) {
            ...
            return view("nptl-admin/common/tax/edit", $data);
        } else {
            return redirect(SM::smAdminSlug('taxes'))
