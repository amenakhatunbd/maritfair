<div class="header-mini">
    <div class="row container-fluid">
        <div class="navbar-brand">
            <a class=""><i class="fa fa-phone"></i> {{ SM::get_setting_value('mobile') }}</a> &nbsp;&nbsp;&nbsp;&nbsp;
            <a href="mailto:sales@brandbychoice.com"><i class="fa fa-envelope"> </i> {{ SM::get_setting_value('email') }}</a>
        </div>
        <div class="navbar-collapse" id="navbar_collapse_0">

            <ul class="nav-item navbar-top-right" style="float:right;">
                @if(Auth::check())
                    <li class="nav-item">
                        <div class="nav-link">
                        <span class="p-pic">
                            <img src="{!! SM::sm_get_the_src(Auth::user()->image,30,30) !!}"
                                                 alt="image">
                        </span>Welcome&nbsp;{{Auth::user()->username}}
                        </div>

                    </li>
                    <li class="nav-item"><a href="{{ url('/dashboard') }}" class="nav-link -before"><i
                                    class="fa fa-home"> </i> Dashboard</a></li>
                    <li class="nav-item"><a href="{{url('/logout')}}" class="nav-link -before"><i
                                    class="fa fa-power-off"> </i> Logout</a></li>
                @else
                    <li class="nav-link nav-welcome">Welcome Guest!</li>
                    <li class="nav-login-reg">
                        <a data-toggle="modal" data-target="#onlyloginModal" class="btn btn-secondary btn-login-style"
                           id="loginButton" xibkh="1">
                            Sign in
                        </a>
                    </li>
                    <li class="nav-login-reg">
                        <a data-toggle="modal" data-target="#onlyRegisterModal"
                           class="btn btn-secondary btn-login-style" id="quickReg">
                            Register
                        </a>
                    </li>
                @endif
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12  col-sm-12 col-md-3 spaceright-0 logo-paddin animatable bounceIn">
                    ...
                    <a href="{{URL('/')}}" class="logo">
                        <img class="logo-style" alt="{{ SM::get_setting_value('site_name') }}"
                ...
                <div class="col-12  col-sm-12 col-md-6">
                    ...
                    <div class="input-group md-form form-sm form-2 pl-0">
                        ...
                        ?>
                        @if($header_marquee_enable == 1)
                            <marquee onmouseover="this.stop();" onmouseout="this.start();"
                                     style="margin:9px;color: #000; font-weight: bold;">{{ $header_marquee_title }}</marquee>
                        @endif
                        @if(count($more_then_discount_amount)>0)
                            <marquee onmouseover="this.stop();" onmouseout="this.start();"
                                     style="margin:9px;color: #000; font-weight: bold; display:none;">{{ $more_then_discount_amount->title }}</marquee>
                        @endif
                        <input class="form-control my-0 py-1 amber-border input-md" id="myInput" type="text"
                ...
                <div class="col-12 col-sm-5 col-md-3 spaceleft-0  cart-list-icon">
                    <ul class="top-right-list">
                        ...
                        <li>
                            <a class="btn btn-secondary checkout_style" href="{{URL('cart')}}" id="check_out">
                                Checkout
                            </a>
                        </li>
                    </ul>
