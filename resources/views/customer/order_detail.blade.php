            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php
                        $sm_get_site_logo = SM::sm_get_the_src(SM::sm_get_site_logo(), 230, 50);
                        ...
                        <!-- mobile device -->
                            ...
                            <div class="row">
                                <div class="col-lg-8 hidden-xs col-sm-8">
                                    <div class="invoice-author-information">
                                        @if(!empty($orderUser))
                                            ...
                                            <p class="inv_to"> Invoice To :</p>
                                            <h3>{{ $name }}</h3>
                                            <p><span style="font-weight: bold; color: #000">Address </span>:
                                                {!!  $address !!}</p>
                                            <p><span style="font-weight: bold; color: #000; font-family: 'Poppins'">Phone </span>:
                                                {{ $orderUser->mobile }}</p>
                                            <p><span style="font-weight: bold; color: #000">Email </span>:
                                                {{ $order->contact_email }}
                                            </p>
                                ...
                                <div class="col-lg-4 hidden-xs col-sm-6">
                                    <div class="invoice-author-information1">
                                        <h1 class="ab-inv-title hidden-xs">
                                            invoice
                                        </h1>
                                        <p>
                                            <label style="font-weight: 700; color: #000">Invoice No</label>
                                            : {{ $order->invoice_no }}
                                        </p>
                                        <p class="date">
                                            <label style="font-weight: 700; color: #000"> Date</label>
                                            : {{ date('d-m-Y', strtotime($order->created_at)) }}

                                        </p>
                                        <p style="display:none;">
                                            <label style="font-weight: 700; color: #000">Order Status</label> :
                                            <span><?php
                                                if ($order->order_status == 1) {
                                                    echo 'Completed';
                                                } else if ($order->order_status == 2) {
                    ...
                    <div class="total-amount-item row hidden-xs " style="background: #f9fdff">
                        <div class="col-lg-7 col-sm-7">
                            <div class="left-amount-process">
                                <p><label style="font-weight: 700; color: #000">Amount in Words</label>: <span>
                                {{ title_case(SM::sm_convert_number_to_words($order->grand_total)) }}
                                Taka only.
                            </span>
                                </p>
                                <p><label style="font-weight: 700; color: #000"> Payment Status </label>: <span><?php
                                ...
                                ?>
                                @if($due < 0)
                                    <p><label style="font-weight: 700; color: #000"> Due Status </label>: <span>
                                            {{ $dueSign.' '. SM::currency_price_value(abs($due)) }}
                                        </span></p>
                                ...
                                ?>
                                <p><label style="font-weight: 700; color: #000"> Payment
                                        Method </label>: <span>
                        ...
                        <div class="col-lg-5 col-sm-6">
                            <div class="right-total-amount-process">
                                <p class="clearfix"
                                   style="">
                                    ...
                                    <span class="pull-right ab-inv-total-price">{{ SM::order_currency_price_value($order->id,$order->gross_amount) }}</span>
                                </p>
                            ...
                            ?>
                            <div class="author-signature-content pull-right" style="display: none;">
