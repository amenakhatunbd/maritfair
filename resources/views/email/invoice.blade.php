                    ...
                    <table bgcolor="#f5f5f5" style="background: #f5f5f5; padding: 40px 40px;" class="container"
                        ...
                        <tr>
                            <td align="left" valign="middle">
                                ...
                                @endif
                                <h1 style="font-weight: 500; font-size: 24px; color: #000; line-height: 27px; margin-top: 0;display:none;">
                    ...
                    <tr>
                        <td align="left" valign="top" width="80%" style="padding-bottom: 30px; padding-left: 28px;"
                            ...
                            @if(count($orderUser)>0)
                                ...
                                <h4 style=" font-size: 18px; font-weight: 400; color: #000; margin-bottom: 5px; padding-top: 0px; margin-top: 13px;">
                                    Invoice To :
                                </h4>
                                <h3 style="font-size: 24px; font-weight: 600; line-height: 36px; color: #000; margin-bottom: 4px; margin-top: 0;">
                                    {{ $name }}</h3>
                        ...
                        <td align="left" valign="top" width="20%" style="padding-bottom: 30px;"
                            ...
                            <p class="text-left"
                               style="font-size: 16px; font-weight: 500; color: #605f5f; line-height: 18px; padding-left: 30px; text-align: left;display:none;">
                                Order Status : <span style="color: #000;"><?php
                                    if ($order->order_status == 1) {
                                        echo 'Completed';
                                    } else if ($order->order_status == 2) {
                                        echo 'Processing';
                            ...
                            @foreach($order->detail as $detail)
                                ...
                                <tr style="border-bottom: 1px solid #dddddd;">
                                    ...
                                    <td style="width: 13%; border-bottom: 1px solid #dddddd;" valign="middle"
                                        align="center">
                                        <p style="font-size: 18px; font-weight: 600; color: #000; line-height: 28px; margin-bottom: 0;">
                ...
                <table width="100%" bgcolor="#f9fdff" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td valign="middle" class="column no-padding" align="left"
                            ...
                            <p style="font-size: 16px; color: #000; margin-bottom: 0; border-bottom: 1px solid #dddddd; font-weight: 600; padding: 5px 20px 5px 27px;">
                                Sub Total : <span
                                        style="text-align: right; float: right">{{ SM::currency_price_value($order->gross_amount) }}</span>
                            </p>
                            ...
                            @if($order->discount>0)
                                ...
                                <p style="font-size: 16px; color: #000; margin-bottom: 0; font-weight: 600; padding: 5px 20px 10px 27px;">
                                    Discount :<span
                ...
                <table width="100%" bgcolor="#f9fdff" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td valign="middle" class="width100 padding-left30" align="left"
                            ...
                            <h3 style="font-size: 16px; font-weight: 700; color: #000; margin: 0;">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="width: 100%;"
                    ...
                    <tr bgcolor="#1d2d5d">
                        ...
                        <td valign="middle" class="single-table-pert1 column"
                            ...
                            valign="middle">E : <a style="color: #fff;" href="mailto:{{ $email }}">{{ $email }}</a>
                        </td>
