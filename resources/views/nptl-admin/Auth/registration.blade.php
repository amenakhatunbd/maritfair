    ...
    <div class="well no-padding">
        <form class="smart-form client-form" id="smart-form-register"  role="form" method="POST" action="{{ url(config('constant.smAdminSlug').'/register') }}">
            ...
            <fieldset>
                ...
                <section>
                    <label class="input{{ $errors->has('business_name') ? ' state-error' : '' }}">
                        <i class="icon-append fa fa-user"></i>
                        <input type="text" required class="{{ $errors->has('business_name') ? 'invalid' : '' }}" name="business_name" placeholder="Business Name" value="{{ old('business_name') }}">
                        <b class="tooltip tooltip-bottom-right">Enter your business_name</b> </label>
                    @if ($errors->has('business_name'))
                        <em class="invalid" for="business_name">{{ $errors->first('business_name') }}</em>
                    @endif
                </section>
                    <section>
