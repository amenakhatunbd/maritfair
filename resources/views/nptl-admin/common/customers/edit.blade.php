...
@section('content')
    ...
    <section id="widget-grid" class="">
        <!-- row -->
        <div class="row">
            {!! Form::model($user,["method"=>"PATCH","action"=>["Admin\Common\Customers@update",$user->id]]) !!}
            @include(('nptl-admin/common/customers/form'),['f_name'=>__("common.edit"), 'btn_name'=>__("common.update")])
            {!! Form::close() !!}
