                            ...
                            <div class="col-sm-12">
                                <div class="box">
                                    <div class="box-body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="col-sm-4">
                                                    <div class="sm-form form-group {{ $errors->has('import_file') ? ' has-error' : '' }}">
                                                        {{ Form::label('import_file', 'File To Import(xlsx):', array('class' => 'requiredStar')) }}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <a href="{{ asset('files/Book2part1.xlsx') }}"
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="box-body">
                                        <strong>Follow the instructions carefully before importing the
                                            file.</strong><br>
                                        <strong>Please Fill Out Any 
                                        <span class="text-danger">Blank Cell</span> 
                                        with 
                                        <span class="text-danger">Unknown</span> in 
                                        <span class="">(Product Name,</span>
                                        <span class="">Author Name,</span>
                                        <span class="">Category Name,</span>
                                        <span class="requiredStar">Publisher Name)</span>
                                        </strong>
                                        <br>
                                        The columns of the XLSX file should be in the following order. <br><br>
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                <td>1</td>
                                                <td>no
                                                    <small class="text-muted requiredStar"></small>
                                                </td>
                                                <td>Serial</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>Name of the product in Bangla</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>bangla english name
                                                    <small class="text-muted requiredStar">(Required)</small>
                                                </td>
                                    ...
                                    <div class="box-body" style="display:none;">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>Product Stock Status(in_stock, out_of_stock, on_backorder)
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>8</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Product Type <br>
                                                    <strong>Available Options: Simple</strong>
