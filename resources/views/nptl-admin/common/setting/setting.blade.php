                            ...
                            <div class="widget-body">
                                <fieldset>
                                    ...
                                    <div class="form-group{{ $errors->has('hotline') ? ' has-error' : '' }}">
                                        <label class="col-md-2 control-label"
                                               for="hotline">Hotline</label>
                                        <div class="col-md-10">
                                            <input name="hotline" id="hotline" class="form-control"
                                                   placeholder="Hotline" type="text"
                                                   value="{{ old('hotline')!='' ? old('hotline') : SM::get_setting_value('hotline') }}">
                                    ...
                                    <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <input name="mobile" id="mobile" class="form-control"
                                                   ...
                                                   value="{{ old('mobile')!='' ? old('mobile') : SM::get_setting_value('mobile') }}">
                    ...
                    <div class="jarviswidget" id="wid-cache-setting">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a onclick="return confirm('Are you sure?');" class="btn btn-warning" href="{{route('getDBEmpty')}}">{{ __( 'add_new.full_data_empty' ) }}</a>
                                        <a onclick="return confirm('Are you sure?');" class="btn btn-danger" href="{{route('migrateRefresh')}}">{{ __( 'add_new.migrate_refresh' ) }}</a>
                                    </div>
                                </div>
