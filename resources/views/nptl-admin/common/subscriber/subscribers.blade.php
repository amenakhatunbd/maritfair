...
if ($all_subscriber)
{
$edit = SM::check_this_method_access( 'subscribers', 'edit' ) ? 1 : 0;
$status_update = SM::check_this_method_access( 'subscribers', 'status_update' ) ? 1 : 0;
$delete = SM::check_this_method_access( 'subscribers', 'destroy' ) ? 1 : 0;
$per = $edit + $delete;
$sl = 1;
...
<tr id="tr_{{$subscriber->id}}">
    ...
    <td class="text-center">
        <select class="form-control change_status"
                route="<?php echo config( 'constant.smAdminSlug' ); ?>/subscriber_status_update"
