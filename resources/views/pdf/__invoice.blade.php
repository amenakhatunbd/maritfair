                    ...
                    <tr>
                        <td align="left" valign="top" width="80%" style="padding-bottom: 30px; padding-left: 28px;"
                            ...
                            @if(!empty($orderUser))
                                ...
                                <h4 style=" font-size: 18px; font-weight: 400; color: #000; margin-bottom: 5px; padding-top: 0px;">
                                    Invoice To :
                                </h4>
                                <h3 style="font-size: 24px; font-weight: 600; line-height: 36px; color: #000; margin-bottom: 4px;">
                                    {{ $name }}</h3>
                                <p style="font-size: 16px; font-weight: 400; color: #000; line-height: 26px; margin-bottom: 0;">
                                ...
                                <p style="font-size: 16px; font-weight: 400; color: #000; line-height: 26px; margin-bottom: 0;">
                                    ...
                                    {{ $orderUser->mobile }}</p>
                                <p style="font-size: 16px; font-weight: 400; color: #000; line-height: 26px; margin-bottom: 10px;">
                        ...
                        <td align="left" valign="top" style="padding-bottom: 30px; padding-right: 0px;"
                            ...
                            <p class="text-left"
                               style="font-size: 16px; font-weight: 500; color: #000; line-height: 18px; margin-left: 15px; text-align: left">
                                <span style="color: #000; font-weight: 700; ">Invoice ID No</span> : {{ $order->invoice_no }}
                            </p>
                            <p class="text-left"
                               style="font-size: 16px; margin-right: 38px; font-weight: 500; color: #000; padding-left: 16px; line-height: 18px; text-align: left">
                                <span style='color: #000; font-weight: 700'>Date :</span>
                                {{ date('d-m-Y', strtotime($order->created_at)) }}
                            </p>
                            <p class="text-left"
                               style="font-size: 16px; font-weight: 500; color: #000; line-height: 18px; padding-left: 16px; text-align: left; display:none;">
                        ...
                        @foreach($order->detail as $detail)
                            ...
                            <tr style="border-bottom: 1px solid #dddddd;">
                                <td style="width: 25%; padding: 18px 0 18px 50px;" valign="top">
                                    <h4 style="font-size: 16px; font-weight: 600; color: #000; line-height: 28px; margin-bottom: 0;">
                                        {{ $title }}</h4>
                                    <?php
                                ...
                                <td style="width: 13%; border-bottom: 1px solid #dddddd;" valign="middle"
                                    align="center">
                                    <p style="font-size: 16px; font-weight: 600; color: #000; line-height: 28px; margin-bottom: 0;">
                ...
                <table width="100%" bgcolor="#f9fdff" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td valign="top" class="column" align="left"
                            ...
                            <p><label style="font-weight: 700; color: #000">Amount in Words</label>: <span style="color: #000; font-weight: bold">
                        ...
                        <td valign="middle" class="column no-padding" align="left"
                            style=" padding-top: 0px; padding-bottom: 20px; background: #f9fdff; padding-left: 0px;">
                            <?php
                            $orderTotalValue = array_sum($orderTotal);
                            ?>
                            <p style="font-size: 16px; color: #000; margin-bottom: 0; border-bottom: 1px solid #dddddd; font-weight: 600; padding: 5px 30px 5px 27px;">
                                Sub Total : <span
                            ...
                            @endif
                            @if($order->discount>0)
                                <p style="font-size: 16px; color: #000; margin-bottom: 0; font-weight: 600; padding: 5px 30px 10px 27px;">
                                    Discount :<span
